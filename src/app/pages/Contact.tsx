        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <nav className="text-sm mb-4 text-primary-foreground/70">
              <Link to="/" className="hover:text-primary-foreground">Home</Link> › Contact Us
            </nav>
            <h1 className="text-5xl md:text-6xl mb-4">Contact Us</h1>
            <p className="text-xl text-primary-foreground/80">{"Let's talk about what you're looking for."}</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <motion.div {...fadeInUp} className="lg:col-span-1">
              ...
              <h2 className="text-3xl mb-6">{"We're Here For Your Family"}</h2>
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Stop by the showroom, give us a call, or fill out the form.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">129 Griffing Avenue<br />Riverhead, NY 11901</p>
                  </div>
                </div>
            ...
            <motion.div {...fadeInUp} className="lg:col-span-2 space-y-8">
              <div className="bg-card p-8 border border-border">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <label htmlFor="serviceType" className="block text-sm mb-2">Type of Memorial / Service</label>
                    <select
                      id="serviceType"
                      name="serviceType"
                  ...
                  <div>
                    <label htmlFor="message" className="block text-sm mb-2">How Can We Help?</label>
                    <textarea
                      id="message"
                      name="message"
              ...
              <div className="bg-card border border-border p-8">
                <h2 className="text-2xl mb-3">Book a Showroom Appointment</h2>
